...
function(e, a) {
	...
	return function(e) {
		...
		console.log("\n %c 回这世界2016 %c http://returntotheworld.com \n\n", "color: #fadfa3; background: #030307; padding:5px 0;", "background: #fadfa3; padding:5px 0;"), t(1);
		var i = [],
			n = function() {
				function e(a) {
					function t(e) {
					...
					if (this.playIndex = "[object Array]" === Object.prototype.toString.call(a.music) ? 0 : -1, this.option = a, this.audios = [], this.loop = a.loop, this.secondToTime = function(e) {
						var a = function(e) {
								return e < 10 ? "0" + e : "" + e
							},
							t = parseInt(e / 60),
					...
					this.lrcs = [], this.updateBar = function(e, a, t) {
						a = a > 0 ? a : 0, a = a < 1 ? a : 1, m[e + "Bar"].style[t] = 100 * a + "%"
					...
					}, this.multiple = this.playIndex > -1, this.music = this.multiple ? this.option.music[this.playIndex] : this.option.music, this.option.showlrc && this.element.classList.add("aplayer-withlrc");
					...
					w.addEventListener("click", function() {
						n.loop ? (w.classList.add("aplayer-noloop"), n.loop = !1, n.audio.loop = !n.multiple && n.loop) : (w.classList.remove("aplayer-noloop"), n.loop = !0, n.audio.loop = !n.multiple && n.loop)
					}), this.multiple && !
					function() {
						var e = n.element.getElementsByClassName("aplayer-list")[0];
						e.style.height = e.offsetHeight + "300px", n.element.getElementsByClassName("aplayer-icon-menu")[0].addEventListener("click", function() {
							e.classList.contains("aplayer-list-hide") ? e.classList.remove("aplayer-list-hide") : e.classList.add("aplayer-list-hide")
						})
					}(), this.setMusic(0), i.push(this)
				}
				return r(e, [{
					key: "setMusic",
					value: function(e) {
						...
						this.music = this.multiple ? this.option.music[t] : this.option.music, this.music.pic && (this.element.getElementsByClassName("aplayer-pic")[0].style.backgroundImage = "url('" + this.music.pic + "')"), this.element.getElementsByClassName("aplayer-title")[0].innerHTML = this.music.title, this.element.getElementsByClassName("aplayer-author")[0].innerHTML = " - " + this.music.author, this.multiple && (this.element.getElementsByClassName("aplayer-list-light")[0] && this.element.getElementsByClassName("aplayer-list-light")[0].classList.remove("aplayer-list-light"), this.element.getElementsByClassName("aplayer-list")[0].getElementsByTagName("li")[t].classList.add("aplayer-list-light")), this.audio && (this.pause(), this.audio.currentTime = 0), this.multiple && !this.audios[t] || this.playIndex === -1 ? (this.audio = document.createElement("audio"), this.audio.src = this.music.url, this.option.preload ? this.audio.preload = this.option.preload : this.audio.preload = this.isMobile ? "none" : "metadata", this.audio.addEventListener("durationchange", function() {
							...
							a.element.getElementsByClassName("aplayer-author")[0].innerHTML = " - Error happens网络异常 ╥﹏╥", a.trigger("pause")
						...
						function() {
								...
								function() {
									...
									r.onreadystatechange = function() {
										if (4 === r.readyState) if (r.status >= 200 && r.status < 300 || 304 === r.status) {
											t = r.responseText, a.lrcs[e] = l(t), a.lrc = a.lrcs[e];
											var i = "";
											a.lrcContents = a.element.getElementsByClassName("aplayer-lrc-contents")[0];
											for (var n = 0; n < a.lrc.length; n++) i += "<p>" + a.lrc[n][1] + "</p>";
											a.lrcContents.innerHTML = i, a.lrcIndex || (a.lrcIndex = 0), a.lrcContents.getElementsByTagName("p")[0].classList.add("aplayer-lrc-current"), a.lrcContents.style.transform = "translateY(0px)", a.lrcContents.style.webkitTransform = "translateY(0px)"
										} else console.log("Request was unsuccessful: " + r.status)
									};
									var i = void 0;
									i = a.multiple ? a.option.music[e].lrc : a.option.music.lrc, r.open("get", i, !0), r.send(null)
							...
							a.lrcContents.innerHTML = r, a.lrcIndex || (a.lrcIndex = 0), a.lrcContents.getElementsByTagName("p")[0].classList.add("aplayer-lrc-current"), a.lrcContents.style.transform = "translateY(0px)", a.lrcContents.style.webkitTransform = "translateY(0px)"
		...
		a = e.exports = t(3)(), a.push([e.id, ".aplayer-narrow{width:66px}.aplayer-narrow .aplayer-info{display:none}.aplayer-withlrc.aplayer-narrow{width:106px}.aplayer-withlrc.aplayer .aplayer-pic{height:106px;width:106px}.aplayer-withlrc.aplayer .aplayer-info{margin-left:106px;height:106px}.aplayer-withlrc.aplayer .aplayer-lrc{display:block}.aplayer{color:#fff;font-family:Arial,Helvetica,sans-serif;border-radius:2px;overflow:hidden;-webkit-user-select:none;-moz-user-select:none;-ms-user-select:none;user-select:none;position:fixed;z-index:4999;bottom:0;left:0;width:100%;}.aplayer *{box-sizing:content-box}.aplayer .aplayer-icon{width:15px;height:15px;border:none;background-color:transparent;outline:none;cursor:pointer;opacity:.8;vertical-align:middle;padding:0}.aplayer .aplayer-icon .aplayer-fill{-webkit-transition:all .2s ease-in-out;transition:all .2s ease-in-out}.aplayer .aplayer-lrc-content{display:none}.aplayer .aplayer-pic{position:relative;float:left;height:66px;width:66px;background-image:url(" + t(4) + ");background-size:100%;-webkit-transition:all .3s ease;transition:all .3s ease}.aplayer .aplayer-pic .aplayer-button{position:absolute;border-radius:50%;opacity:.8;cursor:pointer;text-shadow:0 1px 1px rgba(0,0,0,.2);box-shadow:0 1px 1px rgba(0,0,0,.2);background:rgba(0,0,0,.2);-webkit-transition:all .1s ease;transition:all .1s ease}.aplayer .aplayer-pic .aplayer-button:hover{opacity:1}.aplayer .aplayer-pic .aplayer-button .aplayer-fill{fill:#fff}.aplayer .aplayer-pic .aplayer-hide{display:none}.aplayer .aplayer-pic .aplayer-play{width:40px;height:40px;border:10px solid #fff;bottom:32%;right:36%;margin:0 -15px -15px 0}.aplayer .aplayer-pic .aplayer-play .aplayer-icon-play{position:absolute;top:0px;left:4px;height:40px;width:40px}.aplayer .aplayer-pic .aplayer-pause{width:40px;height:40px;border:5px solid #e27894;background: none repeat scroll 0 0 rgb(239,137,164);bottom:0px;right:0px}.aplayer .aplayer-pic .aplayer-pause .aplayer-icon-pause{position:absolute;top:2px;left:2px;height:38px;width:38px}.aplayer .aplayer-info{margin-left:66px;padding:14px 7px 0 10px;height:66px;box-sizing:border-box}.aplayer .aplayer-info .aplayer-music{overflow:hidden;white-space:nowrap;text-overflow:ellipsis;margin-bottom:13px}.aplayer .aplayer-info .aplayer-music .aplayer-title{font-size:14px}.aplayer .aplayer-info .aplayer-music .aplayer-author{font-size:12px;color:#fff}.aplayer .aplayer-info .aplayer-controller{box-shadow: 0px 0px 40px #f00;position:relative}.aplayer .aplayer-info .aplayer-controller .aplayer-bar-wrap{margin:0 140px 0 -10px;padding:4px 0;cursor:pointer!important}.aplayer .aplayer-info .aplayer-controller .aplayer-bar-wrap .aplayer-bar{position:relative;height:2px;width:100%;background:#cdcdcd}.aplayer .aplayer-info .aplayer-controller .aplayer-bar-wrap .aplayer-bar .aplayer-loaded{position:absolute;left:0;top:0;bottom:0;background:#aaa;height:2px;-webkit-transition:all .5s ease;transition:all .5s ease}.aplayer .aplayer-info .aplayer-controller .aplayer-bar-wrap .aplayer-bar .aplayer-played{position:absolute;left:0;top:0;bottom:0;height:8px;background: none repeat scroll 0 0 rgb(239,137,164);box-shadow: 0 0 6px #e27894;}.aplayer .aplayer-info .aplayer-controller .aplayer-bar-wrap .aplayer-bar .aplayer-played .aplayer-thumb{position:absolute;top:0;right:5px;margin-top:-4px;margin-right:-10px;height:12px;width:12px;border-radius:50%;background:#fff;cursor:pointer!important}.aplayer .aplayer-info .aplayer-controller .aplayer-time{position:absolute;right:0;bottom:-3px;height:17px;color:#999;font-size:11px}.aplayer .aplayer-info .aplayer-controller .aplayer-time .aplayer-time-inner{vertical-align:middle}.aplayer .aplayer-info .aplayer-controller .aplayer-time .aplayer-icon{cursor:pointer;-webkit-transition:all .2s ease;transition:all .2s ease}.aplayer .aplayer-info .aplayer-controller .aplayer-time .aplayer-icon .aplayer-fill{fill:#fff}.aplayer .aplayer-info .aplayer-controller .aplayer-time .aplayer-icon.aplayer-icon-loop{margin-right:4px}.aplayer .aplayer-info .aplayer-controller .aplayer-time .aplayer-icon.aplayer-noloop .aplayer-fill{fill:#ddd}.aplayer .aplayer-info .aplayer-controller .aplayer-time .aplayer-icon.aplayer-noloop:hover .aplayer-fill{fill:#bbb}.aplayer .aplayer-info .aplayer-controller .aplayer-time .aplayer-icon:hover .aplayer-fill{fill:#000}.aplayer .aplayer-info .aplayer-controller .aplayer-time.aplayer-time-narrow .aplayer-icon-loop,.aplayer .aplayer-info .aplayer-controller .aplayer-time.aplayer-time-narrow .aplayer-icon-menu{display:none}.aplayer .aplayer-info .aplayer-controller .aplayer-volume-wrap{position:relative;display:inline-block;margin-left:3px;cursor:pointer!important}.aplayer .aplayer-info .aplayer-controller .aplayer-volume-wrap:hover .aplayer-volume-bar-wrap{display:block}.aplayer .aplayer-info .aplayer-controller .aplayer-volume-wrap .aplayer-volume-bar-wrap{display:none;position:absolute;bottom:15px;right:-3px;width:25px;height:40px;z-index:99}.aplayer .aplayer-info .aplayer-controller .aplayer-volume-wrap .aplayer-volume-bar-wrap .aplayer-volume-bar{position:absolute;bottom:0;right:10px;width:5px;height:35px;background:#aaa}.aplayer .aplayer-info .aplayer-controller .aplayer-volume-wrap .aplayer-volume-bar-wrap .aplayer-volume-bar .aplayer-volume{position:absolute;bottom:0;right:0;width:5px;-webkit-transition:all .1s ease;transition:all .1s ease}.aplayer .aplayer-lrc{display:none;position:relative;height:40px;text-align:center;margin:0px 0 5px}.aplayer .aplayer-lrc:before{top:0;height:10%;filter:progid:DXImageTransform.Microsoft.gradient(startColorstr='#ffffff',endColorstr='#00ffffff',GradientType=0)}.aplayer .aplayer-lrc:after,.aplayer .aplayer-lrc:before{position:absolute;z-index:1;display:block;overflow:hidden;width:100%;content:' '}.aplayer .aplayer-lrc:after{bottom:0;height:33%;filter:progid:DXImageTransform.Microsoft.gradient(startColorstr='#00ffffff',endColorstr='#ffffff',GradientType=0)}.aplayer .aplayer-lrc p{font-size:40px;color:#fff;line-height:30px!important;height:19.8px!important;padding:0!important;margin:0!important;-webkit-transition:all .9s ease-out;transition:all .9s ease-out;opacity:.06;text-shadow: -1px -1px 1px rgba(0,0,0,0.4),2px 2px 1px rgba(255,255,255,0.5);font-family: '&#12498;&#12521;&#12462;&#12494;&#35282;&#12468;Pro W3','Hiragino Kaku Gothic Pro',Osaka,'&#12513;&#12452;&#12522;&#12458;',Meiryo,'&#65325;&#65331;&#65328;&#12468;&#12471;&#12483;&#12463;','MS PGothic',sans-serif;font-weight: bold;white-space: nowrap;}.aplayer .aplayer-lrc p.aplayer-lrc-current{opacity:1}.aplayer .aplayer-lrc .aplayer-lrc-contents{width:100%;-webkit-transition:all .5s ease-out;transition:all .5s ease-out}.aplayer .aplayer-list{overflow:auto;-webkit-transition:all .5s ease;background: none repeat scroll 0 0 rgb(239,137,164);transition:all .5s ease;box-shadow:0px 0px 100px #e27894;}.aplayer .aplayer-list.aplayer-list-hide{height:0!important}.aplayer .aplayer-list ol{list-style-type:none;margin:0;padding:0}.aplayer .aplayer-list ol li{position:relative;height:32px;line-height:32px;padding:0 15px;font-size:12px;border-top:1px solid #e9e9e9;cursor:pointer;-webkit-transition:all .2s ease;transition:all .2s ease;overflow:hidden}.aplayer .aplayer-list ol li:hover{background:rgba(60, 145, 179, 0.43);}.aplayer .aplayer-list ol li.aplayer-list-light{background:rgba(248, 133, 169, 0.41);}.aplayer .aplayer-list ol li.aplayer-list-light .aplayer-list-cur{display:inline-block}.aplayer .aplayer-list ol li .aplayer-list-cur{display:none;width:3px;height:22px;position:absolute;left:0;top:5px;cursor:pointer}.aplayer .aplayer-list ol li .aplayer-list-index{color:#fff;margin-right:12px;cursor:pointer}.aplayer .aplayer-list ol li .aplayer-list-author{color:#fff;float:right;cursor:pointer}@-webkit-keyframes aplayer-roll{0%{left:0}to{left:-100%}}@keyframes aplayer-roll{0%{left:0}to{left:-100%}}", ""])
	}, function(e, a) {
		e.exports = function() {
			var e = [];
		...
		function p(e, a) {
			...
			if (a.singleton) {
				var i = g++;
				t = v || (v = o(a)), l = c.bind(null, t, i, !1), r = c.bind(null, t, i, !0)
		...
		function c(e, a, t, l) {
			...
			if (e.styleSheet) e.styleSheet.cssText = x(a, r);
				...
				var i = document.createTextNode(r),
					n = e.childNodes;
				n[a] && e.removeChild(n[a]), n.length ? e.insertBefore(i, n[a]) : e.appendChild(i)
			}
		}
		function u(e, a) {
			var t = a.css,
